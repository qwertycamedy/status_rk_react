    ...
    <header className="absolute w-full pb-[22px] lg:pb-[46px] text-nowrap">
      <Container className="flex flex-wrap xl:flex-nowrap justify-center gap-[22px] items-center xl:justify-between lg:gap-[60px]">
        <div className="w-full flex flex-wrap lg:flex-nowrap items-center gap-[35px] lg:gap-[50px]">
          ...
          <ul className="w-full lg:w-auto flex items-center justify-between gap-0 lg:gap-[15px] xl:-order-2">
            {navLinks.map((link, i) => (
              <li key={i}>
                <MyLink
                  className="!p-0 lg:!py-[8px] lg:!px-[14px]"
                  variant="text-blue"
                  href={link.href}
                >
                  {link.text}
        ...
        <div className="flex items-center gap-[30px]">
          <MyLink variant="text-blue" href={"tel:+77017067666"}>
            +7 701 706 76 66
          </MyLink>
          <ul className="flex items-center gap-[6px]">
            <li>
              <a
                ...
                href="https://www.instagram.com/status_rk/"
                target="_blank"
              >
                <img
                  width={24}
